...
<header id="header" class="container">
    ...
    <div id="content" class="container" >
        ...
        <div id="main" class="row-fluid">
            <div id="main-left" class="span8">
                <div id="slider" class="clearfix">
                    <div id="slide-left" class="flexslider span8" style="width: 100%; height: 465px;">
                        <ul class="slides">
                        <?php for ($i=0; $i < 6 ; $i++) {  ?>
                            <li data-thumb="<?php echo $featured_sources[$i]; ?>" style="background-image: url(./images/bbb.jpg);background-repeat: no-repeat;background-size: 100%; " >
                                <a href="./news.php?id=<?php echo $featured_slugs[$i]; ?>" title="<?php echo $featured_headlines[$i]; ?>" rel="bookmark">
                                <img width="770" height="291"  src="<?php echo $featured_sources[$i]; ?>" alt="<?php echo $featured_headlines[$i]; ?>" >
                                </a>
                                <div class="entry">
                                    <h4><?php echo $featured_headlines[$i]; $small = substr($featured_contents[$i], 0, 60); ?>                           
                                    </h4>
                                    <p><?php echo $small; ?>...</p>
                                </div>
                            </li>
             ...
             <div style="background-color: white; padding: 5px 5px 0px 5px"> 
                <div id="home-top">
                    <h3 class="title" ><span class="heads">Events</span></h3>
                    <ul class="bxslider">
                ...
                <div id="home-middle" class="clearfix"  >
                    <div class="left span6 " style="background-color: white; padding: 5px 0px 0px 5px;">
                        <h3 class="title"><a href="category.php?cat=Apparel" title="Apparel"><span >Apparel</span></a></h3>
                        <div class="row-fluid"> 
                        <article class="post">
                                <a class="image_thumb_zoom" href="news.php?id=<?php echo $a_slugs[0]; ?>" title="<?php echo $a_headlines[0]; ?>" rel="bookmark">
                                <img width="371" height="177" src="<?php echo $a_sources[0]; ?>" alt="" />
                                </a>
                                <div style="height: 50px; width: 80%; display: inline-block; position: relative;">
                                <h4 class="post-title">
                                <a href="news.php?id=<?php echo $a_slugs[0]; ?>" title="<?php echo $a_headlines[0]; ?>" rel="bookmark"><?php echo $a_headlines[0]; ?></a>
                                </div>
                                <span class="date" style="width: 19%; height:  15%; position: relative; right: 0px;"><?php echo $a_card_date[0]; ?></span>
                                </h4>
                        ...
                        <article class="post">
                                <div class="entry clearfix">
                                    ...
                                    <div style="height: 50px; width: 70%; display: inline-block; position: relative;">
                                    <h4 class="post-title"><?php echo $a_headlines[1]; ?></h4>
                                    </div>
                                    </a>
                                    <p><?php $small = substr($a_contents[1], 0, 60); echo $small; ?>...</p>
                                    <div class="meta">
                            ...
                            <article class="post">
                                <div class="entry clearfix">
                                    <a href="news.php?id=<?php echo $a_slugs[2]; ?>" title="<?php echo $a_headlines[2]; ?>" rel="bookmark">
                                    <img width="225" height="136" src="<?php echo $a_sources[2]; ?>" class="thumb" alt="" />
                                    <div style="height: 50px; width: 70%; display: inline-block; position: relative;">
                                    <h4 class="post-title"><?php echo $a_headlines[2]; ?></h4>
                                    </div>
                                    </a>
                                    <p><?php $small = substr($a_contents[2], 0, 60); echo $small; ?>...</p>
                                    <div class="meta">
                    ...
                    <div class="right span6" style="background-color: white; padding: 5px 0px 0px 5px; width: 48.4%">
                        <h3 class="title"><a href="category.php?cat=Textile" title="Textile"><span>Textile</span></a></h3>
                            <div class="row-fluid">
                                <article class="post">
                                <a class="image_thumb_zoom" href="news.php?id=<?php echo $t_slugs[0]; ?>" title="<?php echo $t_headlines[0]; ?>" rel="bookmark">
                                ...
                                <span class="date" style="width: 19%; height:  15%; position: relative; right: 0px;"><?php echo $t_card_date[0]; ?></span>
                        ...
                        <article class="post">
                                <div class="entry clearfix">
                                    ...
                                    <p><?php $small = substr($t_contents[1], 0, 60); echo $small; ?>...</p>
                                    <div class="meta">
                            ...
                            <article class="post">
                                <div class="entry clearfix">
                                    <a href="news.php?id=<?php echo $t_slugs[2]; ?>" title="<?php echo $t_headlines[2]; ?>" rel="bookmark">
                                    <img width="225" height="136" src="<?php echo $t_sources[2]; ?>" class="thumb" alt="" />
                                    <div style="height: 50px; width: 70%; display: inline-block; position: relative;">
                                    <h4 class="post-title"><?php echo $t_headlines[2]; ?></h4>
                                    </a>
                                    </div>
                                    <p><?php $small = substr($t_contents[2], 0, 60); echo $small; ?>...</p>
                                    <div class="meta">
                ...
                <div id="home-middle" class="clearfix"  >
                    <div class="left span6 " style="background-color: white; padding: 5px 0px 0px 5px;">
                        <h3 class="title"><a href="category.php?cat=Technology And Innovation" title="Technology And Innovation"><span>Technology And Innovation</span></a></h3>
                        <div class="row-fluid"> 
                        <article class="post">
                                <a class="image_thumb_zoom" href="news.php?id=<?php echo $i_slugs[0]; ?>" title="<?php echo $i_headlines[0]; ?>" rel="bookmark">
                                <img width="371" height="177" src="<?php echo $i_sources[0]; ?>" alt="" />
                                </a>
                                <div style="height: 50px; width: 80%; display: inline-block; position: relative;">
                                <h4 class="post-title">
                                <a href="news.php?id=<?php echo $i_slugs[0]; ?>" title="<?php echo $i_headlines[0]; ?>" rel="bookmark"><?php echo $i_headlines[0]; ?></a>
                                </div>
                                <span class="date" style="width: 19%; height:  15%; position: relative; right: 0px;"><?php echo $i_card_date[0]; ?></span>
                                </h4>
                                <p><?php $small = substr($i_contents[0], 0, 100); echo $small; ?>...</p>
                            </article>
                        <article class="post">
                                <div class="entry clearfix">
                                    <a href="news.php?id=<?php echo $i_slugs[1]; ?>" title="<?php echo $i_headlines[1]; ?>" rel="bookmark">
                                    <img width="225" height="136" src="<?php echo $i_sources[1]; ?>" class="thumb" alt="" />
                                    <div style="height: 50px; width: 70%; display: inline-block; position: relative;">
                                    <h4 class="post-title"><?php echo $i_headlines[1]; ?></h4>
                                    </div>
                                    </a>
                                    <p><?php $small = substr($i_contents[1], 0, 60); echo $small; ?>...</p>
                                    <div class="meta">
                            ...
                            <article class="post">
                                <div class="entry clearfix">
                                    <a href="news.php?id=<?php echo $i_slugs[2]; ?>" title="<?php echo $i_headlines[2]; ?>" rel="bookmark">
                                    <img width="225" height="136" src="<?php echo $i_sources[2]; ?>" class="thumb" alt="" />
                                    <div style="height: 50px; width: 70%; display: inline-block; position: relative;">
                                    <h4 class="post-title"><?php echo $i_headlines[2]; ?></h4>
                                    </div>
                                    </a>
                                    <p><?php $small = substr($i_contents[2], 0, 60); echo $small; ?>...</p>
                                    <div class="meta">
                    ...
                    <div class="right span6" style="background-color: white; padding: 5px 0px 0px 5px; width: 48.4%">
                        <h3 class="title"><a href="category.php?cat=Retail" title="Retail"><span>Retail</span></a></h3>
                            <div class="row-fluid">
                                <article class="post">
                                <a class="image_thumb_zoom" href="news.php?id=<?php echo $r_slugs[0]; ?>" title="<?php echo $r_headlines[0]; ?>" rel="bookmark">
                                ...
                                <span class="date" style="width: 19%; height:  15%; position: relative; right: 0px;"><?php echo $r_card_date[0]; ?></span>
                        ...
                        <article class="post">
                                <div class="entry clearfix">
                                    ...
                                    <p><?php $small = substr($r_contents[1], 0, 60); echo $small; ?>...</p>
                                    <div class="meta">
                            ...
                            <article class="post">
                                <div class="entry clearfix">
                                    <a href="news.php?id=<?php echo $r_slugs[2]; ?>" title="<?php echo $r_headlines[2]; ?>" rel="bookmark">
                                    <img width="225" height="136" src="<?php echo $r_sources[2]; ?>" class="thumb" alt="" />
                                    <div style="height: 50px; width: 70%; display: inline-block; position: relative;">
                                    <h4 class="post-title"><?php echo $r_headlines[2]; ?></h4>
                                    </a>
                                    </div>
                                    <p><?php $small = substr($r_contents[2], 0, 60); echo $small; ?>...</p>
                                    <div class="meta">
        ...
        <div id="sidebar" class="span4" >
           ...
           <div style="background-color: white; padding: 5px 0px 0px 5px;"> 
            <div class="widget widget_latestpost" ><a href="category.php?cat=Fashion"><h3 class="title"><span class="heads" s >Fashion</span></h3></a>
                <div class="latest-posts" style="background-color: white;">
                    <article class="post" >
                        <a class="image_thumb_zoom" href="news.php?id=<?php echo $f_slugs[0]; ?>" title="<?php echo $f_headlines[0]; ?>" rel="bookmark">
                        ...
                        <span class="date" style="width: 19%; height:  15%; position: relative; right: 0px;"><?php echo $f_card_date[0]; ?></span>
                        <p>  <?php $small = substr($f_contents[0], 0, 100); echo $small; ?>...</p>
                    </article>
                
                    <article class="post" >
                        <div class="entry clearfix">
                            <a href="news.php?id=<?php echo $f_slugs[1]; ?>" title="<?php echo $f_headlines[1]; ?>">
                            <img width="225" height="136" src="<?php echo $f_sources[1]; ?>" class="thumb" alt="" />
                            <div style="height: 50px; width: 70%; display: inline-block; position: relative;">
                            <h4 class="post-title"><?php $small = $f_headlines[1]; echo $small; ?></h4>
                            </div>
                            </a>
                            <p><?php $small = substr($f_contents[1], 0, 60); echo $small; ?>...</p>
                            <div class="meta">
                    ...
                    <article class="post" >
                        <div class="entry clearfix">
                            <a href="news.php?id=<?php echo $f_slugs[2]; ?>" title="<?php echo $f_headlines[2]; ?>" rel="bookmark">
                            <img width="225" height="136" src="<?php echo $f_sources[2]; ?>" class="thumb" alt="" />
                            <div style="height: 48px; width: 70%; display: inline-block; position: relative;">
                            <h4 class="post-title"><?php $small = $f_headlines[2]; echo $small; ?></h4></a>
                            </div>
                            <p><?php $small = substr($f_contents[2], 0, 60); echo $small; ?>...</p>
                            <div class="meta">
            ...
            <div class="widget widget_latestpost"><a href="category.php?cat=Corporate"><h3 class="title"><span class="heads">Corporate</span></h3></a>
                <div class="latest-posts">
                    <article class="post">
                        <a class="image_thumb_zoom" href="news.php?id=<?php echo $c_slugs[0]; ?>" title="<?php echo $c_headlines[0]; ?>" rel="bookmark">
                        <img width="371" height="177" src="<?php echo $c_sources[0]; ?>" alt="" />
                        </a>
                        <div style="height: 48px; width: 80%; display: inline-block; position: relative;">
                        <h4 class="post-title">
                        <a href="news.php?id=<?php echo $c_slugs[0]; ?>" title="<?php echo $c_headlines[0]; ?>" rel="bookmark"><?php $small = $c_headlines[0]; echo $small; ?></a>
                        </h4>
                        </div>
                        <span class="date" style="width: 19%; height:  15%; position: relative; right: 0px;"><?php echo $c_card_date[0]; ?></span>
                        <p><?php $small = substr($c_contents[0], 0, 100); echo $small; ?>...</p>
                    </article>
                
                    <article class="post" style="margin-left: 13px;">
                        <div class="entry clearfix">
                            <a href="news.php?id=<?php echo $c_slugs[1]; ?>" title="<?php echo $c_headlines[1]; ?>">
                            <img width="225" height="136" src="<?php echo $c_sources[1]; ?>" class="thumb" alt="" />
                            <div style="height: 50px; width: 70%; display: inline-block; position: relative;">
                            <h4 class="post-title"><?php $small = $c_headlines[1]; echo $small; ?></h4>
                            </div>
                            </a>
                    ...
                    <article class="post">
                        <div class="entry clearfix">
                            <a href="news.php?id=<?php echo $c_slugs[2]; ?>" title="<?php echo $c_headlines[2]; ?>" rel="bookmark">
                            <img width="225" height="136" src="<?php echo $c_sources[2]; ?>" class="thumb" alt="" />
                            <div style="height: 50px; width: 70%; display: inline-block; position: relative;">
                            <h4 class="post-title"><?php $small = $c_headlines[2]; echo $small; ?></h4></a>
                            </div>
