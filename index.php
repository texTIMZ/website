        ...
        <div id="main" class="row-fluid">
            <div id="main-left" class="span8">
                <div id="slider" class="clearfix">
                    <div id="slide-left" class="flexslider span3" style="width: 100%; height: 465px;">
                        <ul class="slides">
                        <?php for ($i=0; $i < 4 ; $i++) {  ?>
                            <li data-thumb="<?php echo $featured_sources[$i]; ?>" style=background-repeat: no-repeat;background-size: 100%; " >
