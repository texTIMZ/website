    ...
    <div id="content" class="container">
        ...
        <div class="clearfix"  >
                    <div class="left span3 " style="background-color: white; padding: 10px 0px 0px 10px;">
                        ...
                        <div class="row-fluid"> 
                        <article class="post" style="height:400px">
                    ...
                    <div class="right span3" style="background-color: white; padding: 10px 0px 0px 10px;">
                       <h3 class="title" style="width: 95%;background-color: #376980;"><a href="category.php?cat=Textile" title="Textile"><span>Textile</span></a></h3>
                        ...
                        <article class="post" style="height: 200px">
                                <div class="entry clearfix">
                ...
                <div class="clearfix"  >
                    <div class="right span3 " style="background-color: white; padding: 10px 0px 0px 10px;">
                        <h3 class="title" style="width: 95%;background-color: #376980;"><a href="category.php?cat=Technology And Innovation" title="Technology And Innovation"><span>Technology And Innovation</span></a></h3>
                        <div class="row-fluid"> 
                        <article class="post" style="height: 400px;">
                            ...
                            <hr>
                        <article class="post" style="height: 250px;">
                                <div class="entry clearfix">
                    ...
                    <div class="right span3" style="background-color: white; padding: 10px 0px 0px 10px;">
                        <h3 class="title" style="width: 95%;background-color: #376980;"><a href="category.php?cat=Events" title="Events"><span>Events</span></a></h3>
                            <div class="row-fluid">
                                <article class="post" style="height: 400px;">
                                <a class="image_thumb_zoom" href="news.php?id=<?php echo $eve_slugs[0]; ?>" title="<?php echo $eve_headlines[0]; ?>" rel="bookmark">
                                ...
                                <span class="date" style="width: 19%; height:  15%; position: relative; right: 0px;"><?php echo $eve_card_date[0]; ?></span>
                                <p><?php $small = substr($eve_contents[0], 0, 100); echo $small; ?>...</p>
                            </article>
                            <hr>
                        <article class="post" style="height: 250px;">
                                <div class="entry clearfix">
                    ...
                    <div class="right span3" style="background-color: white; padding: 10px 0px 0px 10px;">
                        <h3 class="title" style="width: 95%;background-color: #376980;"><a href="category.php?cat=Technical textile" title="Technical textile"><span>Technical textile</span></a></h3>
                            <div class="row-fluid">
                                <article class="post" style="height: 400px">
                                <a class="image_thumb_zoom" href="news.php?id=<?php echo $tt_slugs[0]; ?>" title="<?php echo $tt_headlines[0]; ?>" rel="bookmark">
                                ...
                                <span class="date" style="width: 19%; height:  15%; position: relative; right: 0px;"><?php echo $tt_card_date[0]; ?></span>
                                <p><?php $small = substr($tt_contents[0], 0, 100); echo $small; ?>...</p>
                            </article>
                            <hr>
                        <article class="post" style="height: 250px">
                                <div class="entry clearfix">
                                    <a href="news.php?id=<?php echo $tt_slugs[1]; ?>" title="<?php echo $tt_headlines[1]; ?>" rel="bookmark">
                                    <img width="225" height="136" src="<?php echo $tt_sources[1]; ?>" class="thumb" alt="" />
                                    <div style="height: 50px; width: 100%; display: inline-block; position: relative;">
                                    <h4 class="post-title"><?php echo $tt_headlines[1]; ?></h4>
                                    </div>
                                    </a>
                                    <p><?php $small = substr($tt_contents[1], 0, 60); echo $small; ?>...</p>
                                    <div class="meta">
                                        <span class="date"><?php echo $tt_card_date[1]; ?></span>
                                    </div>
                                </div>
                            </article>
                    ...
                    <div class="right span3" style="background-color: white; padding: 10px 0px 0px 10px;">
                        <h3 class="title" style="width: 95%;background-color: #376980;"><a href="category.php?cat=Retail" title="Retail"><span>Retail</span></a></h3>
                            <div class="row-fluid">
                                <article class="post" style="height: 400px;">
